...
> 이 계획은 [0002 계획](0002-fft-api-flow-naming-redefine-plan.md)의 API 재정의 이전 함수명(`list_image_paths`, `read_image`, `rotate_image`, `extract_profile`, `compute_fft`, `find_fft_peaks`)을 사용한다. 현재 `fft-spec.md` 기준 구현은 [0003 계획(stage-01)](0003-stage-01-source-skeleton-plan.md)을 따른다.
