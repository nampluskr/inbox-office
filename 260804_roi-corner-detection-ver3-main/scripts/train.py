...
def main():
    ...
    train_loader = get_dataloader("train", args.csv_path, test_csv_path=args.test_csv_path,
        image_size=args.image_size, split_ratio=args.split_ratio, seed=args.seed,
        batch_size=args.batch_size, num_workers=args.num_workers, num_samples=args.train_size)
    valid_loader = get_dataloader("valid", args.csv_path, test_csv_path=args.test_csv_path,
        image_size=args.image_size, split_ratio=args.split_ratio, seed=args.seed,
        batch_size=args.batch_size, num_workers=args.num_workers, num_samples=args.valid_size)
